...
class Main implements BuilderInterface
{
    ...
    public function enqueue_scripts()
    {
        ...
        \wp_localize_script('yabe-webfont-for-pinegrow', 'yabeWebfontPinegrow', ['stylesheet_url' => Cache::get_cache_url(Cache::CSS_CACHE_FILE) . '?ver=' . YABE_WEBFONT::VERSION, 'font_families' => \array_map(static fn($f) => ['name' => $f['title'], 'key' => $f['css']['variable']], Font::get_fonts())]);
    }
}
